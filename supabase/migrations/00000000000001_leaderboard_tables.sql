...
-- Create function to automatically cleanup old snapshots
...
-- Create cron job to update leaderboards (requires pg_cron extension)
CREATE EXTENSION IF NOT EXISTS pg_cron;

-- Schedule the snapshot creation
...
-- Initial population of leaderboards
